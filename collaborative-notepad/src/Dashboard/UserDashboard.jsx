...
function UserDashboard() {
  ...
  async function fetchData() {
    try {
      ...
      const jsonData = await fetch(`https://collab-notes-5lcc.vercel.app/api/notebook/notes/${queryString}`,{mode: 'no-cors'});
      ...
      const getContributors = await fetch(`https://collab-notes-5lcc.vercel.app/api/notebook/contributors/${contributorQuery}`,{mode: 'no-cors'});
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        ...
        const jsonData = await fetch(`https://collab-notes-5lcc.vercel.app/api/user/getUsers`, {method : "POST",mode: 'no-cors',
          headers : {
