...
export function DialogCloseButton({
  ...
  const handleAddGroup = async () => {
    ...
    const fetcher = async () => await fetch(`https://collab-notes-khaki.vercel.app/notebook/notes/update`,{method : "POST",headers : {'Content-type' : "application/json"},body : JSON.stringify(dataObj) ,mode: 'no-cors'});
    const getAllDataAfterDelete = async () => await fetch(`https://collab-notes-khaki.vercel.app/notebook/notes/${userQueryString}`,{mode: 'no-cors'});
  ...
  const handleDelete = async () => {
    ...
    const userQueryString = new URLSearchParams(userParams).toString();
    const deleteFetcher = async () => await fetch(`https://collab-notes-khaki.vercel.app/notebook/notes/${queryString}`,{method : "DELETE",mode: 'no-cors'});
    const getAllDataAfterDelete = async () => await fetch(`https://collab-notes-khaki.vercel.app/notebook/notes/${userQueryString}`,{mode: 'no-cors'});
  ...
  const handleEmailInvite = () => {
    ...
    const fetcher = async () => await fetch(`https://collab-notes-khaki.vercel.app/mail/send-email`,{method : "POST",headers : {'Content-type' : "application/json"},body : JSON.stringify(mailData),mode: 'no-cors'});
